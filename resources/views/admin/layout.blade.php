...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="{{asset('uploads/'.getoption('favicon')->value)}}">
                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <!--li> 
                                ...
                                <a href="{{url('admin/city')}}"><i class="la la-building"></i> <span>City</span></a>

                            </li>

                            <li> 

                                <a href="{{url('admin/category')}}"><i class="la la-folder-o"></i> <span>Category</span></a>

                            </li>

                            <li> 

                                <a href="{{url('admin/brand')}}"><i class="la la-square-o"></i> <span>Brand</span></a>
                            ...
                            <li> 
                                ...
                                <a href="{{url('admin/service')}}"><i class="la la-briefcase"></i> <span>Services</span></a>

                            </li>

                            <li> 
                                
                                <a href="{{url('admin/customer')}}"><i class="la la-user"></i> <span>Customers List</span></a>
                            ...
                            <li> 
                                ...
                                <a href="{{url('admin/pages')}}"><i class="la la-columns"></i> <span>Manage Pages</span></a>

                            </li>

                            <li> 

                                <a href="{{url('admin/options')}}"><i class="la la-gear"></i> <span>Site Options</span></a>
